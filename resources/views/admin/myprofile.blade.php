...
<body>
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a href="/admin/san-pham/index">
                        <img src="/admin/assets/img/brand/blue.png" style="height:42px; padding-right:31px">
                    </a>
                            ...
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown"
                                ...
                                <div class="media align-items-center">
                                    <span class="avatar avatar-sm rounded-circle">
                                        <img alt="Image placeholder" style="height: 40px; width: 40px;" src="{{ Auth::guard('admin')->user()->hinh_anh }}">
                                    </span>
                                    <div class="media-body  ml-2  d-none d-lg-block">
                                        <span class="mb-0 text-sm  font-weight-bold">{{ Auth::guard('admin')->user()->ten }}</span>
                                    </div>
                                </div>
                            </a>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-last-name">Số điện
                                                    thoại</label>
                                                <input type="text" class="form-control text-dark so_dien_thoai"
                    ...
                    <div class="card card-profile">
                                ...
                                <div class="card-profile-image">
                                    <a>
                                        <div id="holder" class="rounded-circle">
                                            <img class="hinh_xyz" src="{{ Auth::guard('admin')->user()->hinh_anh }}" style="height: 169px; width: 169px; border-radius:50%;">
                                        </div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card-body mt-5">
                            ...
                            <div class="text-center mt-3" id="here">
                                <h5 class="h3">
                                    {{ Auth::guard('admin')->user()->ho_lot }}
                                    {{ Auth::guard('admin')->user()->ten }}<span class="font-weight-light">, 21</span>
                                </h5>
                                <div class="h5 font-weight-300">
                                    <i class="ni location_pin mr-2"></i>Quản trị trùm
                                </div>
                                <div class="h5 mt-4">
    ...
    <script src="/admin/script/myprofile/myprofile.js"></script>
</body>
