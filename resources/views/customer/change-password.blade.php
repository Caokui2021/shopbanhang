            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        ...
                        <div class="form-group">
                            <label class="form-label mb-0">Re_Password</label>
                            <input type="password" name="re_password" class="form-control re_password" placeholder="Re_Password">
                        </div>
                        <div class="form-group">
                            <button type="submit" class="form-control btn btn-primary changepass px-3">Reset Password</button>
                        </div>
